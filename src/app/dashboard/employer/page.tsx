      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-8 pl-5 pr-5 h-fit pb-10 absolute">
        <div className="grid2-item bg-indigo-950 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <p>
              ...
              development team. The ideal candidate will have experience in
              designing, developing, and implementing software solutions.
              Responsibilities include writing clean and efficient code,
              debugging programs, and collaborating with other developers to
              create high-quality products.
            </p>
          </div>
          <div className="flex justify-end mt-auto">
            <Link href="/dashboard/employer/jobdetails/1">
              <div className="bg-white text-slate-950 p-2 rounded">
                Know more
              </div>
            </Link>
          </div>
        ...
        <div className="grid2-item bg-rose-800 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <p>
              We are seeking an experienced Marketing Manager to develop and
              implement marketing strategies that will drive growth and brand
              awareness. The ideal candidate will have a proven track record in
              marketing, excellent leadership skills, and the ability to work in
        ...
        <div className="grid2-item bg-rose-800 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <p>
              We are looking for a highly organized and motivated Project
              Manager to lead and manage projects from inception to completion.
              The ideal candidate will be responsible for planning, executing,
              and overseeing projects to ensure they are completed on time and
              within budget.
            </p>
          </div>
          <div className="flex justify-end mt-auto">
        ...
        <div className="grid2-item bg-indigo-950 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <p>
              We are looking for a dedicated Human Resources Specialist to join
              our HR team. The ideal candidate will handle recruitment, employee
              relations, performance management, and compliance with labor laws
              and regulations.
            </p>
          </div>
          <div className="flex justify-end mt-auto">
