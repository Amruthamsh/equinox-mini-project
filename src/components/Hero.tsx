...
const Hero = () => {
  return (
    <div className="pb-50 pt-10 relative">
      <div>
     ...
     <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center relative top-0 left-0 pointer-events-none">
       ...
       <div className='flex justify-center my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          <div className=" w-full flex flex-col items-center justify-center overflow-hidden rounded-md">
           <h1 className='uppercase tracking-widest font-semibold text-5xl text-center ml-1 text-blue-100 max-w-80'>Equinox</h1>
           <TextGenerateEffect
